...
const Registrasi = () => {
  ...
  const handleChange = (event) => {
    setAsalPimpinan(event.target.value);
  }
              ...
              <div className="column is-5-desktop is-12-mobile">
                ...
                <form className="box" onSubmit={Register}>
                  ...
                  <div className="field">
                    ...
                    <div className="control">
                      <div className="select">
                        ...
                        >
                          {selectOption.map((label) => (
                            <option value={label.pimpinanWilayah} key={label.id} >
                              {label.pimpinanWilayah}
                            </option>
                          ))}
                        </select>
                      </div>
                  ...
                  <div className="field p-3 has-text-centered is-centered">
                    ...
                    <Link className="button is-danger" as="button" to={"/"}>
                      Cancel
                    </Link>
                  </div>
                </form>
